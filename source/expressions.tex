...
of a function call are determined as follows:
\begin{itemize}
\item TODO
\end{itemize}
%WORDINGTODO: build up these two lists based on the
% assertions

%WORDINGTODO: make sure we destroy captures properly when we
% restart
