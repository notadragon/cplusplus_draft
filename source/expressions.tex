...
%WORDINGNOTE: If we choose to apply \tcode{const}-ification to postconidition
...
every $C$ in
the precondition assertions and
the postcondition assertions
of the function call.
For each such evaluation,
it is in the precondition evaluations
of the function call if
\begin{itemize}
\item
it is the evaluation of
the predicate of a precondition asssertion,
\item
it is the occurence of
...
in the precondition assertions and postcondition assertions
of the function call.
\item
The initialization of a postcondition capture
associated with a postcondition assertion $A$
shall be after
the first evaluation
associated with a precondition assertion $B$
for any $B$ is in the precondition assertions of the function call
that preceeds $A$ in lexical order.
\item
The evaluation of the predicate
of a precondition assertion $B$
shall be after
the first evaluation of
the initialization of any postcondition capture
associated with a postcondition assertion $A$
for any $A$ in the postcondition assertions of the function call
that preceeds $B$ in lexical order.
\end{itemize}
...
and each precondition evaluation of the function occurs\iref{dcl.contract.func}.
...
all postcondition evaluations of the function occur\iref{dcl.contract.func}.
If the implementation introduces any temporary objects
