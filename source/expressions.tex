...
its type, the result is an erroneous value
...
%WORDINGNOTE: ubdef --- expr.expr.eval
%
...
the behavior is undefined\wordingcomment{\stdstablename{expr.basic.lvalue.strict.aliasing.violation}}.
%WORDINGNOTE: ubdef --- expr.basic.lvalue.strict.aliasing.violation
%
%  runtime-checkable: Yes
%
...
the behavior is undefined\wordingcomment{\stdstablename{expr.basic.lvalue.union.initialization}}.
%WORDINGNOTE: ubdef --- expr.basic.lvalue.union.initialization
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
otherwise, the behavior is undefined\wordingcomment{\stdstablename{expr.type.reference.lifetime}}.
%WORDINGNOTE: ubdef --- expr.type.reference.lifetime
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
\begin{itemize}
\item
if the object is of scalar type,
the object is initialized with an erroneous value
and there is an implicit precondition that this does not occur\iref{basic.contract.implicit},
\item otherwise the behavior is undefined\wordingcomment{\stdstablename{conv.lval.valid.representation}}.
%WORDINGNOTE: ubdef --- conv.lval.valid.representation
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
Otherwise, the result is an erroneous value
with an implicit precondition that this does not occur.\wordingcomment{\stdstablename{conv.double.out.of.range}}.
%WORDINGNOTE: ubdef --- conv.double.out.of.range
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
...
An erroneous value is produced
if the truncated value cannot be represented\wordingcomment{\stdstablename{conv.fpint.float.not.represented}}
%WORDINGNOTE: ubdef --- conv.fpint.float.not.represented
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
...
with an implicit precondition that this does not occur\iref{basic.contract.implicit}.
\begin{note}
...
an erroneous value is produced
with an implicit precondition that this does not occur\wordingcomment{\stdstablename{conv.fpint.int.not.represented}}.
%WORDINGNOTE: ubdef --- conv.fpint.int.not.represented
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
...
the behavior is undefined\wordingcomment{\stdstablename{conv.ptr.virtual.base}}.
%WORDINGNOTE: ubdef --- conv.ptr.virtual.base
%
%  runtime-checkable: Yes
%
...
the behavior is undefined\wordingcomment{\stdstablename{conv.member.missing.member}}.
%WORDINGNOTE: ubdef --- conv.member.missing.member
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
definition results in undefined behavior\wordingcomment{\stdstablename{expr.call.different.type}}.
%WORDINGNOTE: ubdef --- expr.call.different.type
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
the behavior is undefined\wordingcomment{\stdstablename{expr.ref.member.not.similar}}.
%WORDINGNOTE: ubdef --- expr.ref.member.not.similar
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
within its lifetime or
within its period of construction or destruction\iref{class.cdtor},
the behavior is undefined\wordingcomment{\stdstablename{expr.dynamic.cast.pointer.lifetime}}.
%WORDINGNOTE: ubdef --- expr.dynamic.cast.pointer.lifetime
%
%  runtime-checkable: Yes
%
%  locally-checkable: Only for the null pointer case
...
the behavior is undefined\wordingcomment{\stdstablename{expr.dynamic.cast.glvalue.lifetime}}.
%WORDINGNOTE: ubdef --- expr.dynamic.cast.glvalue.lifetime
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
\tcode{D}. Otherwise, the behavior is undefined\wordingcomment{\stdstablename{expr.static.cast.base.class}}.
%WORDINGNOTE: ubdef --- expr.static.cast.base.class
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
otherwise, an erroneous value is produced with
an implicit precondition that this does not occur\iref{basic.contract.implicit}
\wordingcomment{\stdstablename{expr.static.cast.enum.outside.range}}.
%WORDINGNOTE: ubdef --- expr.static.cast.enum.outside.range
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
...
Otherwise, an erroneous value is produced
with an implicit precondition that this does not occur\iref{basic.contract.implicit}\wordingcomment{\stdstablename{expr.static.cast.fp.outside.range}}.
%WORDINGNOTE: ubdef --- expr.static.cast.fp.outside.range
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
...
behavior is undefined\wordingcomment{\stdstablename{expr.static.cast.downcast.wrong.derived.type}}.
%WORDINGNOTE: ubdef --- expr.static.cast.downcast.wrong.derived.type
%
%  runtime-checkable: Yes
%
%  locally-checkable: Only for the null pointer case
...
to the original member. Otherwise, the behavior is undefined\wordingcomment{\stdstablename{expr.static.cast.does.not.contain.orignal.member}}.
%WORDINGNOTE: ubdef --- expr.static.cast.does.not.contain.orignal.member
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
otherwise, the behavior is undefined except as specified in \ref{expr.typeid}\wordingcomment{\stdstablename{expr.unary.dereference}}.
%WORDINGNOTE: ubdef --- expr.unary.dereference
%
%  runtime-checkable: Yes
%
%  locally-checkable: Only for the null pointer case
...
the behavior is undefined\wordingcomment{\stdstablename{expr.new.non.allocating.null}}.
%WORDINGNOTE: ubdef --- expr.new.non.allocating.null
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
...
If not, the behavior is undefined\wordingcomment{\stdstablename{expr.delete.mismatch}}.
%WORDINGNOTE: ubdef --- expr.delete.mismatch
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
\end{footnote}
If not, the behavior is undefined\wordingcomment{\stdstablename{expr.delete.array.mismatch}}.
%WORDINGNOTE: ubdef --- expr.delete.array.mismatch
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
have a virtual destructor or the behavior is undefined\wordingcomment{\stdstablename{expr.delete.dynamic.type.differ}}. In an array delete
%WORDINGNOTE: ubdef --- expr.delete.dynamic.type.differ
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
its static type, the behavior is undefined\wordingcomment{\stdstablename{expr.delete.dynamic.array.dynamic.type.differ}}.
%WORDINGNOTE: ubdef --- expr.delete.dynamic.array.dynamic.type.differ
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
\tcode{E2} refers, the behavior is undefined\wordingcomment{\stdstablename{expr.mptr.oper.not.contain.member}}.
%WORDINGNOTE: ubdef --- expr.mptr.oper.not.contain.member
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
member pointer value\iref{conv.mem}, the behavior is undefined\wordingcomment{\stdstablename{expr.mptr.oper.member.func.null}}.
%WORDINGNOTE: ubdef --- expr.mptr.oper.member.func.null
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
...
the second operand of \tcode{/} or \tcode{\%} is not zero\wordingcomment{\stdstablename{expr.mul.div.by.zero}},
%WORDINGNOTE: ubdef --- expr.mul.div.by.zero
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
...
%
%  replacement: Coerce into erroneous value
and if it is then the operator yields an erroneous value.
...
the operator yields an erroneous value
and there is an implicit precondition that
this does not occur\iref{basic.contract.implicit}\wordingcomment{\stdstablename{expr.mul.representable.type.result}}.
%WORDINGNOTE: ubdef --- expr.mul.representable.type.result
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
...
$i - j$ of \tcode{x} if $0 \le i - j \le n$.
\item Otherwise, the behavior is undefined\wordingcomment{\stdstablename{expr.add.out.of.bounds}}.
%WORDINGNOTE: ubdef --- expr.add.out.of.bounds
%
%  runtime-checkable: Yes
%
...
\end{note}
\item Otherwise, the behavior is undefined\wordingcomment{\stdstablename{expr.add.sub.diff.pointers}}.
%WORDINGNOTE: ubdef --- expr.add.sub.diff.pointers
%
%  runtime-checkable: Yes
%
%  locally-checkable: Only if the array bound is statically known
...
are not similar\iref{conv.qual}, the behavior is undefined\wordingcomment{\stdstablename{expr.add.not.similar}}.
%WORDINGNOTE: ubdef --- expr.add.not.similar
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
less than the width of the promoted left operand\iref{basic.contract.implicit};
if not, an erroneous value is produced\wordingcomment{\stdstablename{expr.shift.neg.and.width}}.
%WORDINGNOTE: ubdef --- expr.shift.neg.and.width
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
...
undefined\wordingcomment{\stdstablename{expr.assign.overlap}}.
%WORDINGNOTE: ubdef --- expr.assign.overlap
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
