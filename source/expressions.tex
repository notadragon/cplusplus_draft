...
the behavior is undefined\wordingcomment{\ubdef{expr.basic.lvalue.strict.aliasing.violation}}.
...
the behavior is undefined\wordingcomment{\ubdef{expr.basic.lvalue.union.initialization}}.
\begin{note}
...
otherwise, the behavior is undefined\wordingcomment{\ubdef{expr.type.reference.lifetime}}.
\begin{note}
...
\item otherwise the behavior is undefined\wordingcomment{\ubdef{conv.lval.valid.representation}}.
\end{itemize}
\begin{example}
\begin{codeblock}
bool f() {
...
with an implicit precondition that this does not occur.\wordingcomment{\ubdef{conv.double.out.of.range}}.
...
if the truncated value cannot be represented\wordingcomment{\ubdef{conv.fpint.float.not.represented}}
...
an erroneous value is produced
with an implicit precondition that this does not occur\wordingcomment{\ubdef{conv.fpint.int.not.represented}}.
If the
...
the behavior is undefined\wordingcomment{\ubdef{conv.ptr.virtual.base}}.
Otherwise,
...
the behavior is undefined\wordingcomment{\ubdef{conv.member.missing.member}}. Otherwise,
...
definition results in undefined behavior\wordingcomment{\ubdef{expr.call.different.type}}.
\begin{note}
...
the behavior is undefined\wordingcomment{\ubdef{expr.ref.member.not.similar}}.
\begin{example}
\begin{codeblock}
struct A { int i; };
struct B { int j; };
...
within its lifetime or
within its period of construction or destruction\iref{class.cdtor},
the behavior is undefined\wordingcomment{\ubdef{expr.dynamic.cast.pointer.lifetime}}.
...
the behavior is undefined\wordingcomment{\ubdef{expr.dynamic.cast.glvalue.lifetime}}.
...
\tcode{D}. Otherwise, the behavior is undefined\wordingcomment{\ubdef{expr.static.cast.base.class}}.
\begin{example}
\begin{codeblock}
struct B { };
struct D : public B { };
...
\wordingcomment{\ubdef{expr.static.cast.enum.outside.range}}.
...
with an implicit precondition that this does not occur\iref{basic.contract.implicit}\wordingcomment{\ubdef{expr.static.cast.fp.outside.range}}.
...
behavior is undefined\wordingcomment{\ubdef{expr.static.cast.downcast.wrong.derived.type}}.
...
to the original member. Otherwise, the behavior is undefined\wordingcomment{\ubdef{expr.static.cast.does.not.contain.orignal.member}}.
\begin{note}
...
otherwise, the behavior is undefined except as specified in \ref{expr.typeid}\wordingcomment{\ubdef{expr.unary.dereference}}.
\begin{note}
...
the behavior is undefined\wordingcomment{\ubdef{expr.new.non.allocating.null}}.
Otherwise,
...
If not, the behavior is undefined\wordingcomment{\ubdef{expr.delete.mismatch}}.
...
\end{footnote}
If not, the behavior is undefined\wordingcomment{\ubdef{expr.delete.array.mismatch}}.
\begin{note}
...
have a virtual destructor or the behavior is undefined\wordingcomment{\ubdef{expr.delete.dynamic.type.differ}}. In an array delete
...
its static type, the behavior is undefined\wordingcomment{\ubdef{expr.delete.dynamic.array.dynamic.type.differ}}.
...
\tcode{E2} refers, the behavior is undefined\wordingcomment{\ubdef{expr.mptr.oper.not.contain.member}}.
...
member pointer value\iref{conv.mem}, the behavior is undefined\wordingcomment{\ubdef{expr.mptr.oper.member.func.null}}.
...
the second operand of \tcode{/} or \tcode{\%} is not zero\wordingcomment{\ubdef{expr.mul.div.by.zero}},
...
this does not occur\iref{basic.contract.implicit}\wordingcomment{\ubdef{expr.mul.representable.type.result}}.
...
$i - j$ of \tcode{x} if $0 \le i - j \le n$.
\item Otherwise, the behavior is undefined\wordingcomment{\ubdef{expr.add.out.of.bounds}}.
...
\end{note}
\item Otherwise, the behavior is undefined\wordingcomment{\ubdef{expr.add.sub.diff.pointers}}.
\end{itemize}
...
are not similar\iref{conv.qual}, the behavior is undefined\wordingcomment{\ubdef{expr.add.not.similar}}.
\begin{example}
\begin{codeblock}
int arr[5] = {1, 2, 3, 4, 5};
...
if not, an erroneous value is produced\wordingcomment{\ubdef{expr.shift.neg.and.width}}.
...
undefined\wordingcomment{\ubdef{expr.assign.overlap}}.
\begin{note}
