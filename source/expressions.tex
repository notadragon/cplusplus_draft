...
the behavior is undefined\noteubdef{expr.basic.lvalue.strict.aliasing.violation}.
...
the behavior is undefined\noteubdef{expr.basic.lvalue.union.initialization}.
\begin{note}
...
otherwise, the behavior is undefined\noteubdef{expr.type.reference.lifetime}.
\begin{note}
...
\end{codeblock}
\end{example}
%NOTE: ubdef --- conv.lval.valid.representation
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
with an implicit precondition that this does not occur.\noteubdef{conv.double.out.of.range}.

%NOTE: ubdef --- conv.double.out.of.range
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
...
%NOTE: ubdef --- conv.fpint.float.not.represented
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
...
the behavior is undefined\noteubdef{conv.ptr.virtual.base}.
Otherwise,
...
the behavior is undefined\noteubdef{conv.member.missing.member}. Otherwise,
...
the behavior is undefined\noteubdef{expr.ref.member.not.similar}.
\begin{example}
\begin{codeblock}
struct A { int i; };
struct B { int j; };
...
within its lifetime or
within its period of construction or destruction\iref{class.cdtor},
the behavior is undefined\noteubdef{expr.dynamic.cast.pointer.lifetime}.
...
the behavior is undefined\noteubdef{expr.dynamic.cast.glvalue.lifetime}.
...
\noteubdef{expr.static.cast.enum.outside.range}.
...
%NOTE: ubdef --- expr.static.cast.enum.outside.range
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
...
with an implicit precondition that this does not occur\iref{basic.contract.implicit}\noteubdef{expr.static.cast.fp.outside.range}.

%NOTE: ubdef --- expr.static.cast.fp.outside.range
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
...
behavior is undefined\noteubdef{expr.static.cast.downcast.wrong.derived.type}.
...
the behavior is undefined\noteubdef{expr.new.non.allocating.null}.
Otherwise,
...
\end{footnote}
If not, the behavior is undefined\noteubdef{expr.delete.array.mismatch}.
\begin{note}
...
have a virtual destructor or the behavior is undefined\noteubdef{expr.delete.dynamic.type.differ}. In an array delete
...
its static type, the behavior is undefined\noteubdef{expr.delete.dynamic.array.dynamic.type.differ}.
...
\tcode{E2} refers, the behavior is undefined\noteubdef{expr.mptr.oper.not.contain.member}.
...
the second operand of \tcode{/} or \tcode{\%} is not zero\noteubdef{expr.mul.div.by.zero},
...
this does not occur\iref{basic.contract.implicit}\noteubdef{expr.mul.representable.type.result}.

%NOTE: ubdef --- expr.mul.representable.type.result
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
...
%NOTE: ubdef --- expr.mul.div.by.zero
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
...
$i - j$ of \tcode{x} if $0 \le i - j \le n$.
\item Otherwise, the behavior is undefined\noteubdef{expr.add.out.of.bounds}.
...
\end{note}
\item Otherwise, the behavior is undefined\noteubdef{expr.add.sub.diff.pointers}.
\end{itemize}
...
if not, an erroneous value is produced\noteubdef{expr.shift.neg.and.width}.

%NOTE: ubdef --- expr.shift.neg.and.width
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
