...
its type, the result is an unspecified erroneous value
...
that this does not occur\iref{basic.contract.implicit}\wordingcomment{\stdstablename{conv.lval.valid.representation}}.
...
to the original member. Otherwise, the behavior is undefined\wordingcomment{\stdstablename{expr.static.cast.does.not.contain.original.member}}.
%WORDINGNOTE: ubdef --- expr.static.cast.does.not.contain.original.member
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
this does not occur\wordingcomment{\stdstablename{expr.mul.div.by.zero}}.
...
if not, an unspecified erroneous value is produced\wordingcomment{\stdstablename{expr.shift.neg.and.width}}.
