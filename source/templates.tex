...
%NOTE: ubdef --- temp.inst.inf.recursion
%
%  wording: [temp.inst]/16: The result of an infinite recursion in instantiation is undefined.
%
%  runtime-checkable: No
%
%  locally-checkable: No
%
%  checking: Compile-time issue; implementation-defined depth limit
%
%  replacement: None (considered a wording bug per CWG3034, out of scope for this paper)
