...
\rSec2[diff.cpp26.lex]{\ref*{lex}: lexical conventions}
...
\begin{itemize}
\item
The \keyword{contract_control} keyword
is added to enable functionality specific to
assertion-control expressions.
\end{itemize}
\effect
Valid \CppXXVI{} code using \keyword{contract_control} as an identifier
...
\effect
Valid \CppXXVI{} code that declares a deallocation function
