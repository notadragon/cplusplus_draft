...
a contract assertion with the assume semantic
is violated
or when control continues after the
...
after evaluating the implicit contract assertion
that guards undefined behavior\iref{basic.contract.implicit}).
