...
\item%
when the search for a handler\iref{except.handle}
exits a contract-violation handler
invoked during the evaluation of a contract assertion
with a nonthrowing evaluation semantic\iref{basic.contract.eval},
or
