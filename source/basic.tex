...
%
%  notes: we need to make the indeterminate nature of a value propagate just like erroneous, where previously that was not needed because anything touchoing an indeterminate value was UB.
...
as parts of other statements and expressions.
...
%WORDINGNOTE: The above exception is not strictly needed, but it is
...
contract assertion\iref{intro.abstract}.
\end{note}
