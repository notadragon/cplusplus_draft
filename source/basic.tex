...
If no such set of objects would give the program defined behavior\wordingcomment{\ubdef{intro.object.implicit.create}},
...
the behavior of the program is undefined\wordingcomment{\ubdef{intro.object.implicit.pointer}}.
...
is undefined behavior\wordingcomment{\ubdef{basic.align.object.alignment}}.
...
\begin{itemize}
\item
  the pointer is used as the operand of a \grammarterm{delete-expression}\wordingcomment{\ubdef{lifetime.outside.pointer.delete}},
...
\item
  ...
  non-static member function of the object\wordingcomment{\ubdef{lifetime.outside.pointer.member}}, or
...
\item
  ...
  to a virtual base class\wordingcomment{\ubdef{lifetime.outside.pointer.virtual}} or to a base class thereof, or
...
\item
  ...
  \keyword{dynamic_cast}\iref{expr.dynamic.cast}\wordingcomment{\ubdef{lifetime.outside.pointer.dynamic.cast}}.
...
\begin{itemize}
\item the glvalue is used to access the object\wordingcomment{\ubdef{lifetime.outside.glvalue.access}}, or
...
\item the glvalue is used to call a non-static member function of the object\wordingcomment{\ubdef{lifetime.outside.glvalue.member}}, or
...
\item the glvalue is bound to a reference to a virtual base class\iref{dcl.init.ref}\wordingcomment{\ubdef{lifetime.outside.glvalue.virtual}}, or
...
\keyword{typeid}\wordingcomment{\ubdef{lifetime.outside.glvalue.dynamic.cast}}.
...
place, the behavior of the program is undefined\wordingcomment{\ubdef{original.type.implicit.destructor}}. This is true
...
its lifetime ended, results in undefined behavior\wordingcomment{\ubdef{creating.within.const.complete.obj}}.
\begin{example}
\begin{codeblock}
struct B {
  B();
...
that they will not produce an indeterminate value\wordingcomment{\ubdef{basic.indet.value}}
...
the behavior is undefined\wordingcomment{\ubdef{basic.stc.alloc.dealloc.constraint}}.
...
returned from a request for zero size is undefined\wordingcomment{\ubdef{basic.stc.alloc.zero.dereference}}.
...
\pnum
If a deallocation function terminates by throwing an exception, the behavior is undefined\wordingcomment{\ubdef{basic.stc.alloc.dealloc.throw}}.
...
an invocation of a deallocation function\iref{basic.stc.dynamic.deallocation}\wordingcomment{\ubdef{basic.compound.invalid.pointer}},
...
operator.
The behavior is undefined\iref{intro.multithread}\wordingcomment{\ubdef{intro.execution.unsequenced.modification}} if
\begin{itemize}
\item
\indextext{side effects}%
...
behavior\wordingcomment{\ubdef{intro.races.data}}.
\begin{note}
...
\pnum
The implementation may assume\wordingcomment{\ubdef{intro.progress.stops}} that any thread will eventually do one of the
following:
\begin{itemize}
\item terminate,
...
behavior\wordingcomment{\ubdef{basic.start.main.exit.during.destruction}}.
...
thread storage duration, the program has undefined behavior\wordingcomment{\ubdef{basic.start.term.use.after.destruction}} if the flow of control
