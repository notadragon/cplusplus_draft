...
\indexdefn{nonthrowing semantics|see{contract evaluation semantics!nonthrowing}}%
An evaluation of a contract assertion
uses one of the following six \defn{evaluation semantics}:
\defnx{ignore}{contract evaluation semantics!ignore},
\defnx{observe}{contract evaluation semantics!observe},
\defnx{\tcode{noexcept}-observe}{contract evaluation semantics!noexcept-observe},
\defnx{enforce}{contract evaluation semantics!enforce},
\defnx{\tcode{noexcept}-enforce}{contract evaluation semantics!noexcept-enforce}, or
\defnx{quick-enforce}{contract evaluation semantics!quick-enforce}.
Observe, enforce, \tcode{noexcept}-observe, \tcode{noexcept}-enforce, and quick-enforce
are \defnx{checking semantics}{contract evaluation semantics!checking};
enforce, \tcode{noexcept}-enforce, and quick-enforce
are \defnx{terminating semantics}{contract evaluation semantics!terminating};
ignore, \tcode{noexcept}-observe, \tcode{noexcept}-enforce, and quick-enforce
are \defnx{nonthrowing semantics}{contract evaluation semantics!nonthrowing}.
...
observe\iref{intro.compliance} or
\tcode{noexcept}-observe.
\end{note}
...
\indextext{contract evaluation semantics!\tcode{noexcept}-enforce}%
...
in a context that is not manifestly constant-evaluated
and the evaluation semantic is
enforce, observe, \tcode{noexcept}-enforce, or \tcode{noexcept}-observe,
...
If the contract-violation handler
returns normally
and the evaluation semantic is enforce or \tcode{noexcept}-enforce,
the program is contract-terminated;
...
the enforce and \tcode{noexcept}-enforce semantics
...
Conversely,
the observe and \tcode{noexcept}-observe semantics
provide the opportunity to
log information about the contract violation
...
invoked from the evaluation of a contract assertion
exits via an exception,
and the evaluation semantic is a nonthrowing semantic,
...
exits via an exception,
and the evaluation semantic is not a nonthrowing semantic,
