...
If no such set of objects would give the program defined behavior\wordingcomment{\stdstablename{intro.object.implicit.create}},
%WORDINGNOTE: ubdef --- intro.object.implicit.create
%
...
the behavior of the program is undefined\wordingcomment{\stdstablename{intro.object.implicit.pointer}}.
%WORDINGNOTE: ubdef --- intro.object.implicit.pointer
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
is undefined behavior\wordingcomment{\stdstablename{basic.align.object.alignment}}.
%WORDINGNOTE: ubdef --- basic.align.object.alignment
%
%  runtime-checkable: Yes
%
...
\begin{itemize}
\item
  the pointer is used as the operand of a \grammarterm{delete-expression}\wordingcomment{\stdstablename{lifetime.outside.pointer.delete}},
%WORDINGNOTE: ubdef --- lifetime.outside.pointer.delete
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
\item
  ...
  non-static member function of the object\wordingcomment{\stdstablename{lifetime.outside.pointer.member}}
%WORDINGNOTE: ubdef --- lifetime.outside.pointer.member
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
\item
  ...
  to a virtual base class\wordingcomment{\stdstablename{lifetime.outside.pointer.virtual}}
%WORDINGNOTE: ubdef --- lifetime.outside.pointer.virtual
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
%
%  replacement: None
or to a base class thereof, or
\item
  the pointer is used as the operand of a
  \keyword{dynamic_cast}\iref{expr.dynamic.cast}\wordingcomment{\stdstablename{lifetime.outside.pointer.dynamic.cast}}.
%WORDINGNOTE: ubdef --- lifetime.outside.pointer.dynamic.cast
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
\begin{itemize}
\item the glvalue is used to access the object\wordingcomment{\stdstablename{lifetime.outside.glvalue.access}}
%WORDINGNOTE: ubdef --- lifetime.outside.glvalue.access
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
%  replacement: None
, or
\item the glvalue is used to call a non-static member function of the object\wordingcomment{\stdstablename{lifetime.outside.glvalue.member}}
%WORDINGNOTE: ubdef --- lifetime.outside.glvalue.member
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
%  replacement: None
, or
\item the glvalue is bound to a reference to a virtual base class\iref{dcl.init.ref}\wordingcomment{\stdstablename{lifetime.outside.glvalue.virtual}}
%WORDINGNOTE: ubdef --- lifetime.outside.glvalue.virtual
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
\keyword{typeid}\wordingcomment{\stdstablename{lifetime.outside.glvalue.dynamic.cast}}.
%WORDINGNOTE: ubdef --- lifetime.outside.glvalue.dynamic.cast
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
place, the behavior of the program is undefined\wordingcomment{\stdstablename{original.type.implicit.destructor}}
%WORDINGNOTE: ubdef --- original.type.implicit.destructor
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
its lifetime ended, results in undefined behavior\wordingcomment{\stdstablename{creating.within.const.complete.obj}}.
\begin{example}
\begin{codeblock}
struct B {
  B();
...
\end{codeblock}
\end{example}
%WORDINGNOTE: ubdef --- creating.within.const.complete.obj
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
that they will not produce an indeterminate value\wordingcomment{\stdstablename{basic.indet.value}}
%WORDINGNOTE: ubdef --- basic.indet.value
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
%
%  notes: we need to make the indeterminate nature of a value propagate just like erroneous, where previously that was not needed because anything touching an indeterminate value was UB.
...
the behavior is undefined\wordingcomment{\stdstablename{basic.stc.alloc.dealloc.constraint}}.
%WORDINGNOTE: ubdef --- basic.stc.alloc.dealloc.constraint
%
...
returned from a request for zero size is undefined\wordingcomment{\stdstablename{basic.stc.alloc.zero.dereference}}.
%WORDINGNOTE: ubdef --- basic.stc.alloc.zero.dereference
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
\pnum
If a deallocation function terminates by throwing an exception, the behavior is undefined\wordingcomment{\stdstablename{basic.stc.alloc.dealloc.throw}}.
%WORDINGNOTE: ubdef --- basic.stc.alloc.dealloc.throw
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
%
%  checking: Assertion in a catch handler if not made ill-formed by \cite{P3424R0}
%
%  replacement: None
...
an invocation of a deallocation function\iref{basic.stc.dynamic.deallocation}\wordingcomment{\stdstablename{basic.compound.invalid.pointer}},
%WORDINGNOTE: ubdef --- basic.compound.invalid.pointer
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
operator.
The behavior is undefined\iref{intro.multithread}\wordingcomment{\stdstablename{intro.execution.unsequenced.modification}} if
%WORDINGNOTE: ubdef --- intro.execution.unsequenced.modification
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
...
%
%  note: Needs more careful specification work, defer to future paper.
\begin{itemize}
\item
\indextext{side effects}%
...
behavior\wordingcomment{\stdstablename{intro.races.data}}.
%WORDINGNOTE: ubdef --- intro.races.data
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
\pnum
The implementation may assume\wordingcomment{\stdstablename{intro.progress.stops}}
%WORDINGNOTE: ubdef --- intro.progress.stops
%
%  runtime-checkable: No
%
%  locally-checkable: No
...
%
%  note: Needs more careful specification work, defer to future paper.
that any thread will eventually do one of the
following:
\begin{itemize}
\item terminate,
...
behavior\wordingcomment{\stdstablename{basic.start.main.exit.during.destruction}}.
%WORDINGNOTE: ubdef --- basic.start.main.exit.during.destruction
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
thread storage duration, the program has undefined behavior\wordingcomment{\stdstablename{basic.start.term.use.after.destruction}}
%WORDINGNOTE: ubdef --- basic.start.term.use.after.destruction
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
...
%WORDINGNOTE: The above note makes it clear that the places where we
