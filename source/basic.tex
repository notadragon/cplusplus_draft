...
\pnum
The locus of a \grammarterm{postcondition-capture}\iref{basic.contract.capture}
...
consists of
\begin{itemize}
\item the initialization of any postcondition captures of $C$, 
\item the evaluation of the predicate of $C$,
\item the occurance of a contract violation based on the result of $C$, and
\item the destruction of any postcondition captures that were initialized.
\end{itemize}
