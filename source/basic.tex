...
\item
  ...
  non-static member function of the object\wordingcomment{\ubdef{lifetime.outside.pointer.member}}
...
\begin{itemize}
\item the glvalue is used to access the object\wordingcomment{\ubdef{lifetime.outside.glvalue.access}}
...
%  replacement: None
, or
\item the glvalue is used to call a non-static member function of the object\wordingcomment{\ubdef{lifetime.outside.glvalue.member}}
...
%  replacement: None
, or
\item the glvalue is bound to a reference to a virtual base class\iref{dcl.init.ref}\wordingcomment{\ubdef{lifetime.outside.glvalue.virtual}}
...
\pnum
The implementation may assume\wordingcomment{\ubdef{intro.progress.stops}}
...
thread storage duration, the program has undefined behavior\wordingcomment{\ubdef{basic.start.term.use.after.destruction}}
