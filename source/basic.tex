...
immediate after the execution of the associated postcondition
...
other than a potential contract violation are evaluated.
...
the $B$ was determined to be \keyword{true}.
\end{note}
