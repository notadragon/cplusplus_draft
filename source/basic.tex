...
% P3400, which will introduce an expression as part of a contract assertoin
...
\pnum
The \defnadj{execution of a}{contract assertion}
...
\pnum
The execution of a contract assertion using the ignore semantic
...
\pnum
The execution of a contract assertion $C$
using a checking semantic
consists of
\begin{itemize}
\item the initializations of each postcondition captures of $C$, in order,
\item the evaluation of the predicate of $C$,
\item the occurance of a contract violation based on the result of $C$, and
\item the destruction of each postcondition capture of $C$, in reverse order.
\end{itemize}

\pnum
The execution of a contract assertion
using a checking semantic
...
Destruction of postcondition captures may result in
