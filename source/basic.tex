...
%     for things like variuos aspects of the coroutine promise object.
...
$S$ is not part of the immediate conetxt\iref{temp.deduct.general}.
\end{note}
...
or is convertible to \tcode{std::contracts::violation_handled}.
\end{itemize}
...
\defnadj{alowed}{contract evaluation semantic}
...
If the this expression has a value
