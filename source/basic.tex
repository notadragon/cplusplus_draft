...
the behavior of the program is undefined\noteubdef{intro.object.implicit.pointer}.
...
is undefined behavior\noteubdef{basic.align.object.alignment}.
...
\item
  ...
  non-static member function of the object\noteubdef{lifetime.outside.pointer.member}, or
...
\item
  ...
  to a virtual base class\noteubdef{lifetime.outside.pointer.virtual} or to a base class thereof, or
...
\item
  ...
  \keyword{dynamic_cast}\iref{expr.dynamic.cast}\noteubdef{lifetime.outside.pointer.dynamic.cast}.
...
\begin{itemize}
\item the glvalue is used to access the object\noteubdef{lifetime.outside.glvalue.access}, or
...
\item the glvalue is bound to a reference to a virtual base class\iref{dcl.init.ref}\noteubdef{lifetime.outside.glvalue.virtual}, or
...
\keyword{typeid}\noteubdef{lifetime.outside.glvalue.dynamic.cast}.
...
place, the behavior of the program is undefined\noteubdef{original.type.implicit.destructor}. This is true
...
that they will not produce an indeterminate value\noteubdef{basic.indet.value}
...
the behavior is undefined\noteubdef{basic.stc.alloc.dealloc.constraint}.
...
\pnum
If a deallocation function terminates by throwing an exception, the behavior is undefined\noteubdef{basic.stc.alloc.dealloc.throw}.

%NOTE: ubdef --- basic.stc.alloc.dealloc.throw
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
...
operator.
The behavior is undefined\iref{intro.multithread}\noteubdef{intro.execution.unsequenced.modification} if
\begin{itemize}
\item
\indextext{side effects}%
...
%NOTE: ubdef --- intro.execution.unsequenced.modification
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
...
\pnum
The implementation may assume\noteubdef{intro.progress.stops} that any thread will eventually do one of the
following:
\begin{itemize}
\item terminate,
...
%NOTE: ubdef --- intro.progress.stops
%
%  runtime-checkable: No
%
%  locally-checkable: No
...
behavior\noteubdef{basic.start.main.exit.during.destruction}.
...
thread storage duration, the program has undefined behavior\noteubdef{basic.start.term.use.after.destruction} if the flow of control
