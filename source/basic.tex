...
associated with an operation with undefined behavior
does not occur
will be evaluated (and thus violated)
if the operation
is reached during execution.
The behavior itself is then undefined if the
contract-violation handler return normally\iref{basic.contract.handler}.
\end{note}
