...
\item
  ...
  to a virtual base class\wordingcomment{\ubdef{lifetime.outside.pointer.virtual}}
...
place, the behavior of the program is undefined\wordingcomment{\ubdef{original.type.implicit.destructor}}
