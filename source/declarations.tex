...
\nontermdef{postcondition-specifier}\br
  \terminal{post} \opt{attribute-specifier-seq} \opt{postcondition-captures} \terminal{(} \opt{result-name-introducer} conditional-expression \terminal{)}
\end{bnf}
...
\begin{bnf}
\nontermdef{postcondition-capture-clause}\br
...
\begin{bnf}
\nontermdef{postcondition-capture}
  postcondition-param-capture\br
  postcondition-init-capture
\end{bnf}

\begin{bnf}
\nontermdef{postcondition-simple-capture}\br
