...
lifetime\iref{basic.life} results in undefined behavior\wordingcomment{\ubdef{dcl.type.cv.modify.const.obj}}.
...
the behavior is undefined\wordingcomment{\ubdef{dcl.type.cv.access.volatile}}.
...
results in undefined behavior\wordingcomment{\ubdef{dcl.ref.incompatible.function}}.
...
results in undefined behavior\wordingcomment{\ubdef{dcl.ref.incompatible.type}}.
...
is undefined\wordingcomment{\ubdef{dcl.ref.uninitialized.reference}}.
...
that is not suspended results in undefined behavior\wordingcomment{\ubdef{dcl.fct.def.coroutine.resume.not.suspended}}.
...
program has undefined behavior\wordingcomment{\ubdef{dcl.fct.def.coroutine.destroy.not.suspended}}.
...
that this does not occur\iref{basic.contract.implicit}\wordingcomment{\ubdef{dcl.attr.assume.false}}.
...
the behavior is runtime-undefined\wordingcomment{\ubdef{dcl.attr.noreturn.eventually.returns}}.
