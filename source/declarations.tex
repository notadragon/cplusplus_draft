...
\nontermdef{precondition-specifier}\br
  \terminal{pre} \opt{requires-clause} \opt{attribute-specifier-seq} \terminal{(} conditional-expression \terminal{)}
\end{bnf}

\begin{bnf}
\nontermdef{postcondition-specifier}\br
  \terminal{post} \opt{requires-clause} \opt{attribute-specifier-seq} \br
