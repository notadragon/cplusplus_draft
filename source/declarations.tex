...
\nontermdef{precondition-specifier}\br
  \terminal{pre} \opt{attribute-specifier-seq} \opt{requires-clause} \terminal{(} conditional-expression \terminal{)}
\end{bnf}

\begin{bnf}
\nontermdef{postcondition-specifier}\br
  \terminal{post} \opt{attribute-specifier-seq} \opt{requires-clause} \terminal{(} \opt{result-name-introducer} conditional-expression \terminal{)}
\end{bnf}
