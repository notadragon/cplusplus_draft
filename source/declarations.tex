...
\nontermdef{precondition-specifier}\br
  \terminal{pre} \opt{assertion-control-specifier} \opt{attribute-specifier-seq} \terminal{(} conditional-expression \terminal{)}
\end{bnf}

\begin{bnf}
\nontermdef{postcondition-specifier}\br
  \terminal{post} \opt{assertion-control-specifier} \opt{attribute-specifier-seq} \terminal{(} \opt{result-name-introducer} conditional-expression \terminal{)}
\end{bnf}
