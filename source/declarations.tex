...
\nontermdef{static_assert-declaration}\br
  ...
  \keyword{static_assert} \terminal{(} constant-expression \terminal{,} diagnostic-message \terminal{)} \terminal{;}
\end{bnf}
...
the \grammarterm{diagnostic-message}\iref{basic.message} is
...
the \grammarterm{diagnostic-message}, if one is supplied.
\begin{example}
\begin{codeblock}
...
\nontermdef{precondition-specifier}\br
  \terminal{pre} \opt{attribute-specifier-seq} \terminal{(} conditional-expression \terminal{)}\br
  \terminal{pre} \opt{attribute-specifier-seq} \terminal{(} conditional-expression \terminal{,} diagnostic-message \terminal{)}
\end{bnf}

\begin{bnf}
\nontermdef{postcondition-specifier}\br
  \terminal{post} \opt{attribute-specifier-seq} \terminal{(} \opt{result-name-introducer} conditional-expression \terminal{)}\br
  \terminal{post} \opt{attribute-specifier-seq} \terminal{(} \opt{result-name-introducer} conditional-expression \terminal{,} \br
  \bnfindent diagnostic-message \terminal{)}
\end{bnf}
...
\item
both $C_1$ and $C_2$
specify a \grammarterm{diagnostic-message}
with the the same text
or neither do,
\end{itemize}
