...
the behavior is undefined\noteubdef{dcl.type.cv.access.volatile}.
...
results in undefined behavior\noteubdef{dcl.ref.incompatible.function}.
...
results in undefined behavior\noteubdef{dcl.ref.incompatible.type}.
\begin{note}
...
is undefined\noteubdef{dcl.ref.uninitialized.reference}.
\begin{example}
\begin{codeblock}
int &f(int&);
int &g();
...
that is not suspended results in undefined behavior\noteubdef{dcl.fct.def.coroutine.resume.not.suspended}.
...
program has undefined behavior\noteubdef{dcl.fct.def.coroutine.destroy.not.suspended}.
...
that this does not occur\iref{basic.contract.implicit}\noteubdef{dcl.attr.assume.false}.

%NOTE: ubdef --- dcl.attr.assume.false
%
...
the behavior is runtime-undefined\noteubdef{dcl.attr.noreturn.eventually.returns}.
\begin{note}
The function can
