...
int main() {
  std::int32_t x = std::numeric_limits<std::int32_t>::min() / -1;   // undefined behavior\iref{ub:expr.expr.eval}
  std::int32_t y = std::numeric_limits<std::int32_t>::min() % -1;   // undefined behavior
}
\end{codeblock}
\end{example}
...
\tcode{std::uint32_t} is supported\iref{cstdint.syn}.
\begin{codeblock}
#include <cstdint>
