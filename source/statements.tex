...
\nontermdef{assertion-statement}\br
  \terminal{contract_assert} \opt{attribute-specifier-seq} \terminal{(} conditional-expression \terminal{)} \terminal{;}\br
  \terminal{contract_assert} \opt{attribute-specifier-seq} \terminal{(} conditional-expression \terminal{,} \br
  \bnfindent diagnostic-message \terminal{)} \terminal{;}
\end{bnf}
