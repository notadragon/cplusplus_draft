...
\begin{itemize}
\item with a scalar return type
returns an erroneous value
with an implicit precondition assertion that this does not occur\iref{basic.contract.implicit};
\item otherwise it results in undefined behavior\wordingcomment{\stdstablename{stmt.return.flow.off}}.
%WORDINGNOTE: ubdef --- stmt.return.flow.off
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
%
%  checking: Insert \mbox{\tcode{contract_assert(false)}} at end of \emph{function-body}
%
%  replacement: Only for built-in return types: return erroneous value
\end{itemize}
...
results in undefined behavior\wordingcomment{\stdstablename{stmt.return.coroutine.flow.off}}.
%WORDINGNOTE: ubdef --- stmt.return.coroutine.flow.off
%
%  runtime-checkable: Yes
%
%  locally-checkable: Yes
%
%  checking: Insert \mbox{\tcode{contract_assert(false)}} at end of \emph{function-body} if no \tcode{return_void} function is provided
%
%  replacement: Only for built-in return types: return erroneous value.
%
%  note: This requires more careful specification work, as \tcode{return_value()}
%        may be overloaded and there is no clear way to identify the type of
%        erroneous value that could be produced.
...
the variable is being initialized, the behavior is undefined\wordingcomment{\stdstablename{stmt.dcl.local.static.init.recursive}}.
%WORDINGNOTE: ubdef --- stmt.dcl.local.static.init.recursive
%
%  runtime-checkable: Yes
%
%  locally-checkable: No
%
%  checking: Insert a recursion counter into a guard for static and thread-local object construction
%
%  replacement: None
\begin{example}
\begin{codeblock}
