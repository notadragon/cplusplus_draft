...
\item otherwise it results in undefined behavior\wordingcomment{\ubdef{stmt.return.flow.off}}.
...
results in undefined behavior\wordingcomment{\ubdef{stmt.return.coroutine.flow.off}}.
...
the variable is being initialized, the behavior is undefined\wordingcomment{\ubdef{stmt.dcl.local.static.init.recursive}}.
