...
postcondition evaluations
of the function call\iref{dcl.contract.func},
which, in turn,
...
executes all evaluations of each contract assertion
in an evaluation sequence\iref{basic.contract.eval}
of the contract assertions introduced
