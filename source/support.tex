...
#define @\defnlibxname{cpp_lib_contracts_message}@                 xxxxxxL // freestanding, also in \libheader{contracts}
...
\returns
An
\impldef{the contents provided in the \tcode{message} field of \tcode{contract_violation}}
\ntmbs{} in
the ordinary literal encoding\iref{lex.charset}.
...
\recommended
The string returned
should be the \grammarterm{diagnostic-message}
of the violated contract assertion,
if one is supplied;
otherwise it should be a null pointer.
