...
%NOTE: This section defines a mix of concepts and langauge definitions for
...
\pnum
A type \tcode{T} is a \defnadj{quryable}{control type}
if it models \tcode{quryable_label}.
...
namespace std::contracts::labels {
  struct @\placeholder{review_t}@ {
    ...
    consteval evaluation_semantic compute_semantic(evaluation_semantic s) const;
  };
