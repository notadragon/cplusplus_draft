...
the behavior is undefined\wordingcomment{\ubdef{class.dtor.no.longer.exists}} if the destructor is invoked
...
destroyed) from such a constructor (or destructor) is undefined\wordingcomment{\ubdef{class.abstract.pure.virtual}}.%
...
\end{itemize}
the program has undefined behavior\wordingcomment{\ubdef{class.base.init.mem.fun}}.
\begin{example}
\begin{codeblock}
class A {
public:
...
undefined behavior\wordingcomment{\ubdef{class.cdtor.before.ctor}}. For an object with a non-trivial destructor, referring to
any non-static member or base class of the object after the destructor finishes
execution results in undefined behavior\wordingcomment{\ubdef{class.cdtor.after.dtor}}.
\begin{example}
\begin{codeblock}
struct X { int i; };
...
completed, otherwise the conversion results in undefined behavior\wordingcomment{\ubdef{class.cdtor.convert.pointer}}.
...
value) results in undefined behavior\wordingcomment{\ubdef{class.cdtor.form.pointer}}.
\begin{example}
\begin{codeblock}
struct A { };
struct B : virtual A { };
...
is undefined\wordingcomment{\ubdef{class.cdtor.virtual.not.x}}.
\begin{example}
\begin{codeblock}
struct V {
  virtual void f();
...
bases, the behavior is undefined\wordingcomment{\ubdef{class.cdtor.typeid}}.
...
\keyword{dynamic_cast}
results in undefined behavior\wordingcomment{\ubdef{class.cdtor.dynamic.cast}}.
\begin{example}
\begin{codeblock}
struct V {
  virtual void f();
