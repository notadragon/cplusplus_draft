...
\end{example}
\end{note}
%TODO: ubdef{class.dtor.no.longer.exists}
...
pure.
\end{note}
%TODO: ubdef{class.abstract.pure.virtual}
...
is created.
\end{example}
%TODO: ubdef{class.base.init.mem.fun}
...
\end{codeblock}
\end{example}
%TODO: ubdef{class.cdtor.before.ctor}
...
%  checking: Track whether objects are currently being constructed or destroyed
%  replacement: None
%TODO: ubdef{class.cdtor.after.dtor}
...
\end{codeblock}
\end{example}
%TODO: ubdef{class.cdtor.convert.pointer}
...
%  checking: Track whether objects are currently being constructed or destroyed
%  replacement: None
%TODO: ubdef{class.cdtor.form.pointer}
...
\end{codeblock}
\end{example}
%TODO: ubdef{class.cdtor.virtual.not.x}
...
%TODO: ubdef{class.cdtor.dynamic.cast}
