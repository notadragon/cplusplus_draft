...
%WORDINGNOTE: \textbf{ubdef:} \hfil class.dtor.no.longer.exists\hfil
%  \begin{ubsummaryitemize}
%  \item[\textbf{summary:}] invoking a destructor on an object whose lifetime has already ended.
%
...
%
%  \item[\textbf{implementations:}] \tcode{.nonpolymorphic} caught only by constant evaluation
%  (both compilers); \tcode{.polymorphic} caught at runtime by UBSan's \tcode{vptr} check
%  on GCC only.
...
%WORDINGNOTE: \textbf{ubdef:} \hfil class.abstract.pure.virtual\hfil
%  \begin{ubsummaryitemize}
%  \item[\textbf{summary:}] calling a pure virtual function from a constructor or destructor.
%
%  \item[\textbf{runtime-checkable:}] Yes
%
%  \item[\textbf{locally-checkable:}] Yes
%
%  \item[\textbf{checking:}] Insert a \tcode{pre(false)} into the pure virtual stub pointed to from the base-class vtable
%
%  \item[\textbf{replacement:}] None
%
%  \item[\textbf{implementations:}] rejected during constant evaluation on both
%  compilers; and, in the P3850 prototype, checkable at run time on both compilers.
%  \end{ubsummaryitemize}
\indextext{derived class|)}
...
%WORDINGNOTE: \textbf{ubdef:} \hfil class.base.init.mem.fun\hfil
%  \begin{ubsummaryitemize}
%  \item[\textbf{summary:}] calling a member function outside the base classes' constructed
%  lifetime.
%
%  \item[\textbf{runtime-checkable:}] Yes
%
%  \item[\textbf{locally-checkable:}] No
%
%  \item[\textbf{checking:}] Track whether objects are currently being constructed or destroyed
%
%  \item[\textbf{replacement:}] None
%
%  \item[\textbf{implementations:}] For polymorphic types, this can be caught
%  by UBSan's \tcode{vptr}, generally consistently for GCC when nothing else
%  has written to the object's storage.
%  \end{ubsummaryitemize}
\begin{example}
\begin{codeblock}
class A {
...
%WORDINGNOTE: \textbf{ubdef:} \hfil class.cdtor.before.ctor\hfil
%  \begin{ubsummaryitemize}
%  \item[\textbf{summary:}] referring to a member or base of an object before its
%  constructor has begun.
%
%  \item[\textbf{runtime-checkable:}] Yes
%
%  \item[\textbf{locally-checkable:}] No
...
%  \item[\textbf{replacement:}] None
%
%  \item[\textbf{implementations:}] Accesses in non-polymorphic objects are not
%  generally caught.  Accesses in polymorphic types are caught, heuristically, by
%  UBSan's \tcode{vptr} check on both compilers.  GCC accepts non-polymorphic
%  cases at compile time while Clang does not.
%  \end{ubsummaryitemize}
...
%WORDINGNOTE: \textbf{ubdef:} \hfil class.cdtor.after.dtor\hfil
%  \begin{ubsummaryitemize}
%  \item[\textbf{summary:}] referring to a member or base of an object after its destructor
%  has run.
%
%  \item[\textbf{runtime-checkable:}] Yes
%
...
%  \item[\textbf{replacement:}] None
%
%  \item[\textbf{implementations:}] split by polymorphism -- \tcode{.polymorphic} caught by
%  UBSan's \tcode{vptr} check on GCC only; \tcode{.nonpolymorphic} rejected during
%  constant evaluation on both compilers.
%  \end{ubsummaryitemize}
\begin{example}
\begin{codeblock}
struct X { int i; };
...
%WORDINGNOTE: \textbf{ubdef:} \hfil class.cdtor.convert.pointer\hfil
%  \begin{ubsummaryitemize}
%  \item[\textbf{summary:}] converting a pointer to a base class during that base's
%  not-yet-constructed or already-destroyed window.
%
%  \item[\textbf{runtime-checkable:}] Yes
%
%  \item[\textbf{locally-checkable:}] No
...
%WORDINGNOTE: \textbf{ubdef:} \hfil class.cdtor.form.pointer\hfil
%  \begin{ubsummaryitemize}
%  \item[\textbf{summary:}] forming a pointer to a member before construction starts or after
...
%  \item[\textbf{replacement:}] None
%
%  \item[\textbf{implementations:}] For polymorphic objects, caught by UBSan's \tcode{vptr} check on Clang.
%  \end{ubsummaryitemize}
\begin{example}
\begin{codeblock}
struct A { };
...
%WORDINGNOTE: \textbf{ubdef:} \hfil class.cdtor.virtual.not.x\hfil
%  \begin{ubsummaryitemize}
%  \item[\textbf{summary:}] explicit-member-access virtual call during construction or
%  destruction, outside the executing class or its bases.
%
%  \item[\textbf{runtime-checkable:}] Yes
%
%  \item[\textbf{locally-checkable:}] No
...
%WORDINGNOTE: \textbf{ubdef:} \hfil class.cdtor.typeid\hfil
%  \begin{ubsummaryitemize}
%  \item[\textbf{summary:}] \tcode{typeid} on an object under construction or destruction, outside
%  its own class or bases.
%
%  \item[\textbf{runtime-checkable:}] Yes
%
%  \item[\textbf{locally-checkable:}] No
...
%WORDINGNOTE: \textbf{ubdef:} \hfil class.cdtor.dynamic.cast\hfil
%  \begin{ubsummaryitemize}
%  \item[\textbf{summary:}] \tcode{dynamic_cast} on an object under construction or destruction,
%  outside its own class or bases.
%
%  \item[\textbf{runtime-checkable:}] Yes
%
%  \item[\textbf{locally-checkable:}] No
