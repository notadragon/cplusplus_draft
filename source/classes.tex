...
the behavior is undefined\noteubdef{class.dtor.no.longer.exists} if the destructor is invoked
...
\end{itemize}
the program has undefined behavior\noteubdef{class.base.init.mem.fun}.
\begin{example}
\begin{codeblock}
class A {
public:
...
undefined behavior\noteubdef{class.cdtor.before.ctor}. For an object with a non-trivial destructor, referring to
any non-static member or base class of the object after the destructor finishes
execution results in undefined behavior\noteubdef{class.cdtor.after.dtor}.
\begin{example}
\begin{codeblock}
struct X { int i; };
...
is undefined\noteubdef{class.cdtor.virtual.not.x}.
\begin{example}
\begin{codeblock}
struct V {
  virtual void f();
...
\keyword{dynamic_cast}
results in undefined behavior\noteubdef{class.cdtor.dynamic.cast}.
\begin{example}
\begin{codeblock}
struct V {
  virtual void f();
